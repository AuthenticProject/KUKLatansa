...
const MasterDB = (() => {
  ...
  const STORAGE_KEY_EMPLOYEES = 'kuk_master_employees_v6'; // v6: Unifikasi Bagian & Jabatan Karyawan
  const STORAGE_KEY_USERS = 'kuk_master_users';
  const STORAGE_KEY_VEHICLES = 'kuk_master_vehicles';

  const UNITS = ['KUK Bangunan', 'KUK Palen'];
  const DEPARTMENTS = ['Kepala Toko', 'Kepala Gudang', 'Admin', 'Pengiriman', 'Kepala Pengiriman', 'Frontliner'];
  const POSITIONS = ['Kepala Toko', 'Kepala Gudang', 'Admin', 'Pengiriman', 'Kepala Pengiriman', 'Frontliner'];

  // 11 Karyawan Resmi KUK (Database HRD Utama)
  // Bagian: Kepala Toko, Kepala Gudang, Admin, Pengiriman, Kepala Pengiriman, Frontliner
  const DEFAULT_EMPLOYEES = [
    { id: 'K-002', nik: '3502010002', nama: 'Wiba', fullName: 'Wiba Prasetiyo', unit: 'KUK Bangunan', department: 'Admin', position: 'Admin', gajiPokok: 850000, gajiBagian: 250000, sudahBerkeluarga: true, totalPelanggaran: 0, status: 'Active', fingerprintId: '2', hireDate: '2023-01-01', contactNumber: '085712345678' },
    { id: 'K-003', nik: '3502010003', nama: 'Ulin', fullName: 'Nurhadi (Ulin)', unit: 'KUK Bangunan', department: 'Kepala Gudang', position: 'Kepala Gudang', gajiPokok: 850000, gajiBagian: 350000, sudahBerkeluarga: true, totalPelanggaran: 0, status: 'Active', fingerprintId: '3', hireDate: '2022-05-10', contactNumber: '081345678901' },
    { id: 'K-004', nik: '3502010004', nama: 'Kahfi', fullName: 'Kahfi Ashari', unit: 'KUK Bangunan', department: 'Admin', position: 'Admin', gajiPokok: 850000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '4', hireDate: '2023-03-15', contactNumber: '081377889900' },
    { id: 'K-005', nik: '3502010005', nama: 'Agus', fullName: 'Agus Santoso', unit: 'KUK Bangunan', department: 'Kepala Toko', position: 'Kepala Toko', gajiPokok: 850000, gajiBagian: 250000, sudahBerkeluarga: true, totalPelanggaran: 0, status: 'Active', fingerprintId: '5', hireDate: '2021-08-20', contactNumber: '081298765432' },
    { id: 'K-007', nik: '3502010007', nama: 'Alip', fullName: 'Alif Kurniawan', unit: 'KUK Bangunan', department: 'Pengiriman', position: 'Pengiriman', gajiPokok: 850000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '7', hireDate: '2023-06-01', contactNumber: '085733445566' },
    { id: 'K-008', nik: '3502010008', nama: 'Riyan', fullName: 'Ariyan Saputra', unit: 'KUK Bangunan', department: 'Frontliner', position: 'Frontliner', gajiPokok: 850000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '8', hireDate: '2023-07-10', contactNumber: '085711223344' },
    { id: 'K-009', nik: '3502010009', nama: 'Hiba', fullName: 'Hiba Pratama', unit: 'KUK Bangunan', department: 'Frontliner', position: 'Frontliner', gajiPokok: 850000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '9', hireDate: '2023-07-15', contactNumber: '085799887766' },
    { id: 'K-010', nik: '3502010010', nama: 'Rohman', fullName: 'Lailurrohman', unit: 'KUK Bangunan', department: 'Frontliner', position: 'Frontliner', gajiPokok: 850000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '10', hireDate: '2023-08-01', contactNumber: '081288990011' },
    { id: 'K-011', nik: '3502010011', nama: 'Irfan', fullName: 'Irfan Maulana (Logistik)', unit: 'KUK Bangunan', department: 'Kepala Pengiriman', position: 'Kepala Pengiriman', gajiPokok: 850000, gajiBagian: 300000, sudahBerkeluarga: true, totalPelanggaran: 0, status: 'Active', fingerprintId: '11', hireDate: '2023-09-01', contactNumber: '085755667788' },
    { id: 'K-012', nik: '3502020012', nama: 'Nukul', fullName: 'Nukul Hidayat', unit: 'KUK Palen', department: 'Pengiriman', position: 'Pengiriman', gajiPokok: 700000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '12', hireDate: '2023-10-01', contactNumber: '085678912344' },
    { id: 'K-013', nik: '3502020013', nama: 'Miftah', fullName: 'Miftahul Huda', unit: 'KUK Palen', department: 'Frontliner', position: 'Frontliner', gajiPokok: 700000, gajiBagian: 200000, sudahBerkeluarga: false, totalPelanggaran: 0, status: 'Active', fingerprintId: '13', hireDate: '2023-10-15', contactNumber: '081234567811' }
  ];
